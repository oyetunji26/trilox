...
const About = () => {
  return (
    <div className='section bg-blue-100/70'>
        <div className="grid grid-cols-2 flex-col-reverse mt-40 gap-5 items-center">
            <div className=''>
                <Image src={image.Asake2} width={1000} height={1000} alt='askae' className='obk  md:h-[80vh] object-cover w-5/6 mx-auto rounded-3xl -mb-20' />
            </div>
